...
> **Read this first:** the extension is **not in the Rossum Store** — you create the webhook yourself (Extensions → My extensions). It is hosted **only in EU1 and US** (no EU2 Frankfurt, no Japan Tokyo per the KB table). The webhook needs a **token owner with Admin access**.
