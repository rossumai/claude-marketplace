...
| `rossum_update_annotation_content` | ✏️ Write field values via bulk content-operations (replace/add/remove); self-managing start→ops→release; compact result by default (`fields`/`view` params like `rossum_get_annotation`) |
